...
#Liquidation Events - Data Gathering & PRocessing
...
#Analysis of Liquidations events    
...
#Gather Liquidation events time-related data
...
#first histograms from time-related data
def histogramsPlot():
...
#development of normal distribution from time-related data
